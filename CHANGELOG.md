...
- Book detail pages now list chapters in the same shared library grid used everywhere else, so chapters get consistent thumbnails, sizing, and sorting instead of a one-off card layout.
