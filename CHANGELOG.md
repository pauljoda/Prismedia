...
- External manager requests can now reserve one wanted Comic Vine issue in an existing run, apply its exact issue controls, and wait for a verified comic archive before making it readable. A changed issue label or missing run pauses the request for review.
