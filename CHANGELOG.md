...
- Kapowarr can expose existing comic collections, every issue's monitoring state, and exact issue/file associations through read-only library mappings. Missing issues remain visible even when no file has arrived. Comic acquisition controls remain a future addition.
