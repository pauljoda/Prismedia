...
- Kapowarr can expose existing comic collections, every issue's monitoring state, and exact issue/file associations. Reviewed matches link scanned comic issues to their source files, preserving their library identity and reading history when files move or change. Missing issues remain visible even when no file has arrived. Comic acquisition controls remain a future addition.
