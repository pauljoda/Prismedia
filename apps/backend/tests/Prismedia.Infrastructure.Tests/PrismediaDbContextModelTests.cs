...
public sealed class PrismediaDbContextModelTests {
    ...
    [InlineData(typeof(EntitySubtitleStateRow), nameof(EntitySubtitleStateRow.SubtitlesExtractedAt), "subtitles_extracted_at")]
    [InlineData(typeof(EntitySubtitleStateRow), nameof(EntitySubtitleStateRow.SubtitleSidecarSignature), "subtitle_sidecar_signature")]
