...
public interface IIntegrationSourceAcquisitionGateway {
    ...
    /// <summary>Requests the exact selection after the local intent is persisted. Implementations must coalesce repeated requests
    /// without widening or duplicating remote work.</summary>
