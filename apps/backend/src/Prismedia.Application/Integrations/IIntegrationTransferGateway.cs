...
/// <summary>Narrow executor operations. Application handlers authorize each operation and persist side-effect intent before
/// calling this port.</summary>
public interface IIntegrationTransferGateway {
    ...
    Task<TransferInspection> InspectAsync(string pluginId, IntegrationConnectionContext connection,
    ...
    Task<RemoteTransferSnapshot> SubmitAsync(string pluginId, IntegrationConnectionContext connection,
    ...
    Task<FindTransferResult> FindSubmissionAsync(string pluginId, IntegrationConnectionContext connection,
    ...
    Task<RemoteTransferSnapshot> GetJobAsync(string pluginId, IntegrationConnectionContext connection,
    ...
    Task<RemoteTransferSnapshot> CancelAsync(string pluginId, IntegrationConnectionContext connection,
        RemoteTransferJobInput input, CancellationToken cancellationToken);

    /// <summary>Reads one stable page of a sealed output revision.</summary>
    Task<TransferManifestPage> ReadManifestAsync(string pluginId, IntegrationConnectionContext connection,
    ...
    Task<HttpArtifactDelivery> AuthorizeArtifactAsync(string pluginId, IntegrationConnectionContext connection,
    ...
    Task<TransferRetentionResult> RenewRetentionAsync(string pluginId, IntegrationConnectionContext connection,
    ...
    Task<TransferAcknowledgement> AcknowledgeAsync(string pluginId, IntegrationConnectionContext connection,
    ...
    Task<CancelSubmissionResult> CancelSubmissionAsync(string pluginId, IntegrationConnectionContext connection,
        FindTransferInput input, CancellationToken cancellationToken) =>
