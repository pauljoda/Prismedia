...
public interface IIntegrationManagerControlGateway {
    ...
    Task<ManagedControlState> ReconcileAsync(string pluginId, IntegrationConnectionContext connection,
    ...
    Task<ManagedMutationResult> ConfigureAsync(string pluginId, IntegrationConnectionContext connection,
    ...
    Task<ManagedMutationResult> RequestAsync(string pluginId, IntegrationConnectionContext connection,
