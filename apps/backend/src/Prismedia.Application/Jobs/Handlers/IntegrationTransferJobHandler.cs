...
public sealed class IntegrationTransferJobHandler(IIntegrationTransferStore store, SourceTransferProcessor source, RemoteTransferProcessor executor) : IJobHandler {
    /// <inheritdoc />
