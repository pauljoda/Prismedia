    ...
    private static IReadOnlyList<SettingDefinition> BuildDefinitions() {
        var definitions = new List<SettingDefinition> {
            ...
            Boolean(
                ...
                60,
                "Automatically acquire missing subtitles",
                "After local subtitle reconciliation, search configured providers for missing languages using strict identity matching.",
                false,
                21),
            StringList(
                ...
                "Automatic subtitle acquisition.",
                60,
                "Automatic download languages",
                "Comma-separated priority list. This is separate from playback selection so enabling downloads never changes what the player selects.",
                ["en"],
                22),
            Integer(
