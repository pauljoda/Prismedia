...
/// <summary>Reads current metadata provenance and changes field protection under the entity mutation boundary.</summary>
public interface IMetadataFieldService {
    /// <summary>Lists supported metadata fields, including honest unknown history; null means the entity does not exist.</summary>
