...
public static class ManagedRequestEndpoints {
    ...
    public static void MapManagedRequestEndpoints(this RouteGroupBuilder connections) {
        ...
        group.MapPost("/{requestId:guid}/cancel", async (Guid id, Guid requestId, CancelManagedRequestInput request,
            ManagedRequestService service, CancellationToken token) =>
