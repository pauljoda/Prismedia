...
/// <summary>
/// Extension helpers for encoding and decoding closed-set values through the discovered codec registry.
/// </summary>
public static class CodecRegistryExtensions {
    /// <summary>
    /// Encodes a closed-set value with its discovered codec.
    /// </summary>
    /// <typeparam name="TValue">Value type to encode.</typeparam>
    ...
    /// </summary>
    /// <typeparam name="TValue">Value type to decode.</typeparam>
