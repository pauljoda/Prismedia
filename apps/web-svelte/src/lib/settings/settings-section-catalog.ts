...
export const settingsSections: readonly SettingsSection[] = [
  ...
  {
    id: SETTING_SECTION.connections,
    title: "Connections",
    description: "Connect catalogs, download services, and external media managers through installed plugins.",
    href: "/settings/connections",
    icon: icon(Plug as unknown as Component<Record<string, unknown>>),
    accent: PRISM_MATERIAL_SPECTRUM.yellow,
    access: SETTINGS_SECTION_ACCESS.admin,
  },
  {
...
export const settingsDirectoryAccent = PRISM_MATERIAL_SPECTRUM.red;
