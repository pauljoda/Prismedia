...
const thumbnailLabSeedRows: EntityThumbnailRow[] = [
  {
    ...
    cards: [
      card({
        ...
        aspectRatio: "video",
        cover: asset("Big Buck Bunny", forest, graphite, neutralSilver, "video"),
      ...
      card({
        ...
        aspectRatio: "video",
        cover: asset("Flagged Video", burgundy, graphite, neutralSilver, "video"),
  ...
  },
  {
    ...
    cards: [
      card({
        ...
        title: "Demo Shorts",
        aspectRatio: "poster",
        cover: asset("Demo Shorts", burgundy, graphite, neutralSilver, "poster"),
  ...
  },
  {
    ...
    cards: [
      card({
        ...
        title: "Season 01",
        aspectRatio: "poster",
        cover: asset("Season 01", indigo, graphite, neutralSilver, "poster"),
  ...
  },
  {
    ...
    cards: [
      card({
        ...
        aspectRatio: "square",
        cover: asset("Gallery Cover", ember, graphite, neutralSilver, "square"),
      ...
      card({
        ...
        aspectRatio: "square",
        cover: asset("Flagged Gallery", burgundy, ember, neutralSilver, "square"),
  ...
  },
  {
    ...
    cards: [
      card({
        ...
        cover: asset("Image Still", forest, indigo, neutralSilver, "wide"),
  ...
  },
  {
    ...
    cards: [
      card({
        ...
        aspectRatio: "poster",
        cover: asset("Book Cover", burgundy, ember, neutralSilver, "poster"),
  ...
  },
  {
    ...
    cards: [
      card({
        ...
        title: "Volume 01",
        aspectRatio: "poster",
        cover: asset("Volume 01", ember, burgundy, neutralSilver, "poster"),
  ...
  },
  {
    ...
    cards: [
      card({
        ...
        title: "Chapter 01",
        aspectRatio: "poster",
        cover: asset("Chapter 01", forest, burgundy, neutralSilver, "poster"),
  ...
  },
  {
    ...
    label: "Comic Installments",
    cards: [
      card({
        id: "comic-installment-001",
        kind: ENTITY_KIND.comicInstallment,
        title: "Installment 001",
        aspectRatio: "poster",
        cover: asset("Installment 001", indigo, ember, neutralSilver, "poster"),
        capabilities: [position("chapter", 1, "Chapter 1"), stats([{ code: "pages", value: 24 }])],
        meta: [{ icon: "book", label: "24 pages" }],
      }),
    ],
  },
  {
    ...
    cards: [
      card({
        ...
        aspectRatio: "square",
        cover: asset("Audio Album", graphite, indigo, neutralSilver, "square"),
  ...
  },
  {
    ...
    cards: [
      card({
        ...
        title: "Sample Track",
        aspectRatio: "square",
        cover: asset("Sample Track", indigo, forest, neutralSilver, "square"),
  ...
  },
  {
    ...
    cards: [
      card({
        ...
        cover: asset("Person", burgundy, indigo, neutralSilver, "portrait"),
  ...
  },
  {
    ...
    cards: [
      card({
        ...
        title: "Sample Studio",
        aspectRatio: "wide",
        cover: asset("Studio", graphite, forest, neutralSilver, "wide"),
  ...
  },
  {
    ...
    cards: [
      card({
        ...
        title: "Animation",
        aspectRatio: "square",
        cover: asset("Tag", ember, indigo, neutralSilver, "square"),
  ...
  },
  {
    ...
    cards: [
      card({
        ...
        title: "Safe Samples",
        aspectRatio: "video",
        cover: asset("Collection", forest, ember, neutralSilver, "video"),
      ...
      card({
        ...
        aspectRatio: "video",
        cover: asset("Flagged State", burgundy, graphite, neutralSilver, "wide"),
        flagOptions: { isNsfw: true },
