...
export const ENTITY_KIND_DEFINITIONS = {
  ...
  "video-series": { kind: "video-series", displayName: "Video Series", groupLabel: "Series", category: "Media", storageShape: "Folder", presentation: { icon: "series", referenceIcon: "video", thumbnailWidth: 2, thumbnailHeight: 3, primaryAccent: "yellow", secondaryAccent: "green", artworkFit: "cover" }, navigation: {"canonicalBrowseKind":"video-series","destinationId":"series","browsePath":"/series","detailPathTemplate":"/series/{id}","requiredAncestorKind":null,"isTopLevel":true}, search: {"order":1,"expandsRelationshipResults":false}, autoIdentifySelector: "video", containableKinds: null, mediaQualityFamily: "video", supportsFileDeletion: true, supportsAtomicMediaUpgrade: false, supportsManualManagement: false, supportsRequests: true, enumeratesIdentifyChildren: true },
  "video-season": { kind: "video-season", displayName: "Video Season", groupLabel: "Seasons", category: "Media", storageShape: "Folder", presentation: { icon: "season", referenceIcon: "video", thumbnailWidth: 2, thumbnailHeight: 3, primaryAccent: "yellow", secondaryAccent: "green", artworkFit: "cover" }, navigation: {"canonicalBrowseKind":"video-series","destinationId":"series","browsePath":"/series","detailPathTemplate":"/series/{parentId}/seasons/{id}","requiredAncestorKind":"video-series","isTopLevel":false}, search: null, autoIdentifySelector: null, containableKinds: null, mediaQualityFamily: "video", supportsFileDeletion: true, supportsAtomicMediaUpgrade: false, supportsManualManagement: false, supportsRequests: true, enumeratesIdentifyChildren: true },
