...
export const ENTITY_KIND_DEFINITIONS = {
  "audio": { kind: "audio", displayName: "Audio", groupLabel: "Audio", category: "Media", storageShape: "File", presentation: { icon: "audio", referenceIcon: "audio", thumbnailWidth: 1, thumbnailHeight: 1, primaryAccent: "violet", secondaryAccent: "magenta", artworkFit: "cover" }, navigation: null, search: null, autoIdentifySelector: null, identifyPluginFallbackKind: null, containableKinds: null, mediaQualityFamily: "none", supportsFileDeletion: true, supportsAtomicMediaUpgrade: false, supportsManualManagement: false, engagementMode: "none", aggregatesDirectChildPlayback: false, supportsRequests: false, enumeratesIdentifyChildren: false, acquisitionProfile: null },
  "audio-library": { kind: "audio-library", displayName: "Audio Library", groupLabel: "Audio Libraries", category: "Media", storageShape: "Folder", presentation: { icon: "album", referenceIcon: "audio", thumbnailWidth: 1, thumbnailHeight: 1, primaryAccent: "violet", secondaryAccent: "magenta", artworkFit: "cover" }, navigation: {"canonicalBrowseKind":"audio-library","destinationId":"albums","browsePath":"/audio","detailPathTemplate":"/audio/{id}","requiredAncestorKind":null,"isTopLevel":true}, search: {"order":10,"expandsRelationshipResults":false}, autoIdentifySelector: "audio", identifyPluginFallbackKind: null, containableKinds: null, mediaQualityFamily: "audio", supportsFileDeletion: true, supportsAtomicMediaUpgrade: false, supportsManualManagement: false, engagementMode: "playback", aggregatesDirectChildPlayback: false, supportsRequests: true, enumeratesIdentifyChildren: true, acquisitionProfile: {"label":"Music (albums)","displayOrder":3,"libraryRootMediaCapability":"scanAudio","supportedReleaseDateTypes":["release","digital-release","physical-release"],"defaultNamingTemplate":"{Artist}/{Album}","namingHint":"{Artist} {Album} {Year} — 2 segments: artist/album folder (track files keep their release names)","namingFamily":"music"} },
  "audio-track": { kind: "audio-track", displayName: "Audio Track", groupLabel: "Audio Tracks", category: "Media", storageShape: "File", presentation: { icon: "track", referenceIcon: "audio", thumbnailWidth: 1, thumbnailHeight: 1, primaryAccent: "violet", secondaryAccent: "magenta", artworkFit: "cover" }, navigation: {"canonicalBrowseKind":"audio-track","destinationId":"tracks","browsePath":"/tracks","detailPathTemplate":"/audio/tracks/{id}","requiredAncestorKind":null,"isTopLevel":true}, search: {"order":11,"expandsRelationshipResults":false}, autoIdentifySelector: "audio", identifyPluginFallbackKind: null, containableKinds: null, mediaQualityFamily: "audio", supportsFileDeletion: true, supportsAtomicMediaUpgrade: false, supportsManualManagement: false, engagementMode: "playback", aggregatesDirectChildPlayback: false, supportsRequests: true, enumeratesIdentifyChildren: false, acquisitionProfile: null },
  "book": { kind: "book", displayName: "Book", groupLabel: "Books", category: "Media", storageShape: "Archive", presentation: { icon: "book", referenceIcon: "book", thumbnailWidth: 2, thumbnailHeight: 3, primaryAccent: "cyan", secondaryAccent: "blue", artworkFit: "cover" }, navigation: {"canonicalBrowseKind":"book","destinationId":"books","browsePath":"/books","detailPathTemplate":"/books/{id}","requiredAncestorKind":null,"isTopLevel":true}, search: {"order":7,"expandsRelationshipResults":false}, autoIdentifySelector: "book", identifyPluginFallbackKind: null, containableKinds: null, mediaQualityFamily: "none", supportsFileDeletion: true, supportsAtomicMediaUpgrade: false, supportsManualManagement: false, engagementMode: "reading", aggregatesDirectChildPlayback: false, supportsRequests: true, enumeratesIdentifyChildren: true, acquisitionProfile: {"label":"Books","displayOrder":0,"libraryRootMediaCapability":"scanBooks","supportedReleaseDateTypes":["publication","digital-release","physical-release","release"],"defaultNamingTemplate":"{Author}/{Title} ({Year})/{Title}{ - Volume}.{ext}","namingHint":"{Author} {Title} {Year} {ext} — folder/file layout for the book payload","namingFamily":"book"} },
  "book-volume": { kind: "book-volume", displayName: "Book Volume", groupLabel: "Volumes", category: "Media", storageShape: "None", presentation: { icon: "volume", referenceIcon: "book", thumbnailWidth: 2, thumbnailHeight: 3, primaryAccent: "cyan", secondaryAccent: "blue", artworkFit: "cover" }, navigation: {"canonicalBrowseKind":"book","destinationId":"books","browsePath":"/books","detailPathTemplate":"/books/{parentId}/volumes/{id}","requiredAncestorKind":"book","isTopLevel":false}, search: null, autoIdentifySelector: null, identifyPluginFallbackKind: null, containableKinds: null, mediaQualityFamily: "none", supportsFileDeletion: true, supportsAtomicMediaUpgrade: false, supportsManualManagement: false, engagementMode: "reading", aggregatesDirectChildPlayback: false, supportsRequests: false, enumeratesIdentifyChildren: true, acquisitionProfile: null },
  "book-chapter": { kind: "book-chapter", displayName: "Book Chapter", groupLabel: "Chapters", category: "Media", storageShape: "None", presentation: { icon: "chapter", referenceIcon: "book", thumbnailWidth: 2, thumbnailHeight: 3, primaryAccent: "cyan", secondaryAccent: "blue", artworkFit: "cover" }, navigation: {"canonicalBrowseKind":"book","destinationId":"books","browsePath":"/books","detailPathTemplate":"/books/{parentId}/chapters/{id}","requiredAncestorKind":"book","isTopLevel":false}, search: null, autoIdentifySelector: null, identifyPluginFallbackKind: null, containableKinds: null, mediaQualityFamily: "none", supportsFileDeletion: false, supportsAtomicMediaUpgrade: false, supportsManualManagement: false, engagementMode: "reading", aggregatesDirectChildPlayback: false, supportsRequests: false, enumeratesIdentifyChildren: false, acquisitionProfile: null },
  "book-page": { kind: "book-page", displayName: "Book Page", groupLabel: "Pages", category: "Media", storageShape: "ArchiveEntry", presentation: { icon: "page", referenceIcon: "book", thumbnailWidth: 2, thumbnailHeight: 3, primaryAccent: "cyan", secondaryAccent: "blue", artworkFit: "cover" }, navigation: {"canonicalBrowseKind":"book","destinationId":"books","browsePath":"/books","detailPathTemplate":null,"requiredAncestorKind":null,"isTopLevel":false}, search: null, autoIdentifySelector: null, identifyPluginFallbackKind: null, containableKinds: null, mediaQualityFamily: "none", supportsFileDeletion: false, supportsAtomicMediaUpgrade: false, supportsManualManagement: false, engagementMode: "none", aggregatesDirectChildPlayback: false, supportsRequests: false, enumeratesIdentifyChildren: false, acquisitionProfile: null },
  "collection": { kind: "collection", displayName: "Collection", groupLabel: "Collections", category: "Collection", storageShape: "None", presentation: { icon: "collection", referenceIcon: "collection", thumbnailWidth: 16, thumbnailHeight: 9, primaryAccent: "magenta", secondaryAccent: "red", artworkFit: "cover" }, navigation: {"canonicalBrowseKind":"collection","destinationId":"collections","browsePath":"/collections","detailPathTemplate":"/collections/{id}","requiredAncestorKind":null,"isTopLevel":true}, search: {"order":9,"expandsRelationshipResults":false}, autoIdentifySelector: null, identifyPluginFallbackKind: null, containableKinds: ["video","movie","video-series","gallery","image","book","music-artist","audio-library","audio-track"], mediaQualityFamily: "none", supportsFileDeletion: false, supportsAtomicMediaUpgrade: false, supportsManualManagement: false, engagementMode: "none", aggregatesDirectChildPlayback: false, supportsRequests: false, enumeratesIdentifyChildren: false, acquisitionProfile: null },
  "gallery": { kind: "gallery", displayName: "Gallery", groupLabel: "Galleries", category: "Media", storageShape: "Folder", presentation: { icon: "gallery", referenceIcon: "gallery", thumbnailWidth: 1, thumbnailHeight: 1, primaryAccent: "green", secondaryAccent: "cyan", artworkFit: "cover" }, navigation: {"canonicalBrowseKind":"gallery","destinationId":"galleries","browsePath":"/galleries","detailPathTemplate":"/galleries/{id}","requiredAncestorKind":null,"isTopLevel":true}, search: {"order":6,"expandsRelationshipResults":false}, autoIdentifySelector: "gallery", identifyPluginFallbackKind: null, containableKinds: null, mediaQualityFamily: "none", supportsFileDeletion: true, supportsAtomicMediaUpgrade: false, supportsManualManagement: false, engagementMode: "none", aggregatesDirectChildPlayback: false, supportsRequests: false, enumeratesIdentifyChildren: false, acquisitionProfile: null },
  "image": { kind: "image", displayName: "Image", groupLabel: "Images", category: "Media", storageShape: "File", presentation: { icon: "image", referenceIcon: "image", thumbnailWidth: 1, thumbnailHeight: 1, primaryAccent: "blue", secondaryAccent: "violet", artworkFit: "cover" }, navigation: {"canonicalBrowseKind":"image","destinationId":"images","browsePath":"/images","detailPathTemplate":"/images/{id}","requiredAncestorKind":null,"isTopLevel":true}, search: {"order":8,"expandsRelationshipResults":false}, autoIdentifySelector: "image", identifyPluginFallbackKind: null, containableKinds: null, mediaQualityFamily: "none", supportsFileDeletion: true, supportsAtomicMediaUpgrade: false, supportsManualManagement: false, engagementMode: "none", aggregatesDirectChildPlayback: false, supportsRequests: false, enumeratesIdentifyChildren: false, acquisitionProfile: null },
  "music-artist": { kind: "music-artist", displayName: "Music Artist", groupLabel: "Artists", category: "Media", storageShape: "Folder", presentation: { icon: "artist", referenceIcon: "audio", thumbnailWidth: 1, thumbnailHeight: 1, primaryAccent: "violet", secondaryAccent: "magenta", artworkFit: "cover" }, navigation: {"canonicalBrowseKind":"music-artist","destinationId":"artists","browsePath":"/artists","detailPathTemplate":"/artists/{id}","requiredAncestorKind":null,"isTopLevel":true}, search: null, autoIdentifySelector: "audio", identifyPluginFallbackKind: null, containableKinds: null, mediaQualityFamily: "audio", supportsFileDeletion: true, supportsAtomicMediaUpgrade: false, supportsManualManagement: false, engagementMode: "none", aggregatesDirectChildPlayback: false, supportsRequests: true, enumeratesIdentifyChildren: true, acquisitionProfile: null },
  "book-author": { kind: "book-author", displayName: "Book Author", groupLabel: "Authors", category: "Media", storageShape: "Folder", presentation: { icon: "author", referenceIcon: "book", thumbnailWidth: 2, thumbnailHeight: 3, primaryAccent: "cyan", secondaryAccent: "blue", artworkFit: "cover" }, navigation: {"canonicalBrowseKind":"book-author","destinationId":"authors","browsePath":"/authors","detailPathTemplate":"/authors/{id}","requiredAncestorKind":null,"isTopLevel":true}, search: null, autoIdentifySelector: null, identifyPluginFallbackKind: null, containableKinds: null, mediaQualityFamily: "none", supportsFileDeletion: true, supportsAtomicMediaUpgrade: false, supportsManualManagement: false, engagementMode: "none", aggregatesDirectChildPlayback: false, supportsRequests: true, enumeratesIdentifyChildren: true, acquisitionProfile: null },
  "person": { kind: "person", displayName: "Person", groupLabel: "People", category: "Taxonomy", storageShape: "None", presentation: { icon: "person", referenceIcon: "person", thumbnailWidth: 4, thumbnailHeight: 5, primaryAccent: "red", secondaryAccent: "violet", artworkFit: "cover" }, navigation: {"canonicalBrowseKind":"person","destinationId":"people","browsePath":"/people","detailPathTemplate":"/people/{id}","requiredAncestorKind":null,"isTopLevel":true}, search: {"order":3,"expandsRelationshipResults":true}, autoIdentifySelector: null, identifyPluginFallbackKind: null, containableKinds: null, mediaQualityFamily: "none", supportsFileDeletion: false, supportsAtomicMediaUpgrade: false, supportsManualManagement: true, engagementMode: "none", aggregatesDirectChildPlayback: false, supportsRequests: false, enumeratesIdentifyChildren: false, acquisitionProfile: null },
  "movie": { kind: "movie", displayName: "Movie", groupLabel: "Movies", category: "Media", storageShape: "Folder", presentation: { icon: "movie", referenceIcon: "video", thumbnailWidth: 2, thumbnailHeight: 3, primaryAccent: "orange", secondaryAccent: "yellow", artworkFit: "cover" }, navigation: {"canonicalBrowseKind":"movie","destinationId":"movies","browsePath":"/movies","detailPathTemplate":"/movies/{id}","requiredAncestorKind":null,"isTopLevel":true}, search: {"order":0,"expandsRelationshipResults":false}, autoIdentifySelector: "video", identifyPluginFallbackKind: "video", containableKinds: null, mediaQualityFamily: "video", supportsFileDeletion: true, supportsAtomicMediaUpgrade: true, supportsManualManagement: false, engagementMode: "playback", aggregatesDirectChildPlayback: true, supportsRequests: true, enumeratesIdentifyChildren: false, acquisitionProfile: {"label":"Movies","displayOrder":1,"libraryRootMediaCapability":"scanVideos","supportedReleaseDateTypes":["premiere","theatrical-release","streaming-release","digital-release","physical-release","release"],"defaultNamingTemplate":"{Title} ({Year})/{Title} ({Year}).{ext}","namingHint":"{Title} {Year} {Quality} {ext} — 2 segments: folder/file","namingFamily":"movie"} },
  "studio": { kind: "studio", displayName: "Studio", groupLabel: "Studios", category: "Taxonomy", storageShape: "None", presentation: { icon: "studio", referenceIcon: "studio", thumbnailWidth: 21, thumbnailHeight: 9, primaryAccent: "orange", secondaryAccent: "magenta", artworkFit: "contain" }, navigation: {"canonicalBrowseKind":"studio","destinationId":"studios","browsePath":"/studios","detailPathTemplate":"/studios/{id}","requiredAncestorKind":null,"isTopLevel":true}, search: {"order":4,"expandsRelationshipResults":true}, autoIdentifySelector: null, identifyPluginFallbackKind: null, containableKinds: null, mediaQualityFamily: "none", supportsFileDeletion: false, supportsAtomicMediaUpgrade: false, supportsManualManagement: true, engagementMode: "none", aggregatesDirectChildPlayback: false, supportsRequests: false, enumeratesIdentifyChildren: false, acquisitionProfile: null },
  "tag": { kind: "tag", displayName: "Tag", groupLabel: "Tags", category: "Taxonomy", storageShape: "None", presentation: { icon: "tag", referenceIcon: "tag", thumbnailWidth: 1, thumbnailHeight: 1, primaryAccent: "green", secondaryAccent: "yellow", artworkFit: "cover" }, navigation: {"canonicalBrowseKind":"tag","destinationId":"tags","browsePath":"/tags","detailPathTemplate":"/tags/{id}","requiredAncestorKind":null,"isTopLevel":true}, search: {"order":5,"expandsRelationshipResults":true}, autoIdentifySelector: null, identifyPluginFallbackKind: null, containableKinds: null, mediaQualityFamily: "none", supportsFileDeletion: false, supportsAtomicMediaUpgrade: false, supportsManualManagement: true, engagementMode: "none", aggregatesDirectChildPlayback: false, supportsRequests: false, enumeratesIdentifyChildren: false, acquisitionProfile: null },
  "video": { kind: "video", displayName: "Video", groupLabel: "Videos", category: "Media", storageShape: "File", presentation: { icon: "video", referenceIcon: "video", thumbnailWidth: 16, thumbnailHeight: 9, primaryAccent: "red", secondaryAccent: "orange", artworkFit: "cover" }, navigation: {"canonicalBrowseKind":"video","destinationId":"videos","browsePath":"/videos","detailPathTemplate":"/videos/{id}","requiredAncestorKind":null,"isTopLevel":true}, search: {"order":2,"expandsRelationshipResults":false}, autoIdentifySelector: "video", identifyPluginFallbackKind: null, containableKinds: null, mediaQualityFamily: "video", supportsFileDeletion: true, supportsAtomicMediaUpgrade: true, supportsManualManagement: false, engagementMode: "playback", aggregatesDirectChildPlayback: false, supportsRequests: true, enumeratesIdentifyChildren: false, acquisitionProfile: null },
  "video-series": { kind: "video-series", displayName: "Video Series", groupLabel: "Series", category: "Media", storageShape: "Folder", presentation: { icon: "series", referenceIcon: "video", thumbnailWidth: 2, thumbnailHeight: 3, primaryAccent: "yellow", secondaryAccent: "green", artworkFit: "cover" }, navigation: {"canonicalBrowseKind":"video-series","destinationId":"series","browsePath":"/series","detailPathTemplate":"/series/{id}","requiredAncestorKind":null,"isTopLevel":true}, search: {"order":1,"expandsRelationshipResults":false}, autoIdentifySelector: "video", identifyPluginFallbackKind: null, containableKinds: null, mediaQualityFamily: "video", supportsFileDeletion: true, supportsAtomicMediaUpgrade: false, supportsManualManagement: false, engagementMode: "playback", aggregatesDirectChildPlayback: false, supportsRequests: true, enumeratesIdentifyChildren: true, acquisitionProfile: {"label":"TV (series)","displayOrder":2,"libraryRootMediaCapability":"scanVideos","supportedReleaseDateTypes":["premiere","air","first-air","streaming-release","digital-release","release"],"defaultNamingTemplate":"{Series}/Season {Season:00}/{Series} - S{Season:00}E{Episode:00}.{ext}","namingHint":"{Series} {Season} {Season:00} {Episode:00} {Quality} {ext} — 3 segments: series/season/episode","namingFamily":"television"} },
  "video-season": { kind: "video-season", displayName: "Video Season", groupLabel: "Seasons", category: "Media", storageShape: "Folder", presentation: { icon: "season", referenceIcon: "video", thumbnailWidth: 2, thumbnailHeight: 3, primaryAccent: "yellow", secondaryAccent: "green", artworkFit: "cover" }, navigation: {"canonicalBrowseKind":"video-series","destinationId":"series","browsePath":"/series","detailPathTemplate":"/series/{parentId}/seasons/{id}","requiredAncestorKind":"video-series","isTopLevel":false}, search: null, autoIdentifySelector: null, identifyPluginFallbackKind: null, containableKinds: null, mediaQualityFamily: "video", supportsFileDeletion: true, supportsAtomicMediaUpgrade: false, supportsManualManagement: false, engagementMode: "playback", aggregatesDirectChildPlayback: false, supportsRequests: true, enumeratesIdentifyChildren: true, acquisitionProfile: null },
