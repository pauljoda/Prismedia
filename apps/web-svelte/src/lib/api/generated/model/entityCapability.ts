 ...
 */
import type { EntityCapabilityAcquisitionAttributionCapability } from './entityCapabilityAcquisitionAttributionCapability';
...
import type { EntityCapabilityComicInstallmentMetadataCapability } from './entityCapabilityComicInstallmentMetadataCapability';
...
import type { EntityCapabilityExternalLibraryProvenanceCapability } from './entityCapabilityExternalLibraryProvenanceCapability';
...
import type { EntityCapabilityOrderedSequenceCapability } from './entityCapabilityOrderedSequenceCapability';
import type { EntityCapabilityPageSequenceCapability } from './entityCapabilityPageSequenceCapability';
import type { EntityCapabilityPersonProfileCapability } from './entityCapabilityPersonProfileCapability';
import type { EntityCapabilityPlayableAudioCapability } from './entityCapabilityPlayableAudioCapability';
...
export type EntityCapability = EntityCapabilityAcquisitionAttributionCapability | EntityCapabilityBookMetadataCapability | EntityCapabilityClassificationCapability | EntityCapabilityCollectionConfigurationCapability | EntityCapabilityComicInstallmentMetadataCapability | EntityCapabilityConsumptionCapability | EntityCapabilityCoverSelectionCapability | EntityCapabilityCreditsCapability | EntityCapabilityDatesCapability | EntityCapabilityDescriptionCapability | EntityCapabilityEmbeddedAudioMetadataCapability | EntityCapabilityExternalLibraryProvenanceCapability | EntityCapabilityFileManagementCapability | EntityCapabilityFilesCapability | EntityCapabilityFingerprintsCapability | EntityCapabilityFlagsCapability | EntityCapabilityGalleryMetadataCapability | EntityCapabilityImagesCapability | EntityCapabilityLifetimeCapability | EntityCapabilityLinksCapability | EntityCapabilityMarkersCapability | EntityCapabilityOrderedSequenceCapability | EntityCapabilityPageSequenceCapability | EntityCapabilityPersonProfileCapability | EntityCapabilityPlayableAudioCapability | EntityCapabilityPlayableVideoCapability | EntityCapabilityPositionCapability | EntityCapabilityProgressCapability | EntityCapabilityProviderIdentityCapability | EntityCapabilityRatingCapability | EntityCapabilitySeriesMetadataCapability | EntityCapabilitySourceCapability | EntityCapabilityStatsCapability | EntityCapabilitySubtitlesCapability | EntityCapabilityTagPolicyCapability | EntityCapabilityTechnicalCapability;
