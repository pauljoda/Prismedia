    ...
    "inline-flex items-center px-2 py-0.5 text-xs font-medium border rounded-xs",
    {
      variants: {
        variant: {
          ...
          accent:
            "bg-gradient-to-r from-accent-950 to-accent-900 border-accent-500/25 text-accent-300 shadow-[inset_0_1px_0_rgba(242,194,106,0.08),0_0_8px_rgba(242,194,106,0.06)]",
