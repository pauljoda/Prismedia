export const animation = {
  ...
  keyframes: {
    ...
    glowPulse: {
      "0%, 100%": {
        boxShadow:
          "0 0 0 1px rgba(199, 201, 204,0.50), 0 0 10px rgba(199, 201, 204,0.20)",
      },
      "50%": {
        boxShadow:
          "0 0 0 1px rgba(199, 201, 204,0.80), 0 0 20px rgba(199, 201, 204,0.40), 0 0 40px rgba(199, 201, 204,0.15)",
      },
    },
    /**
